...
<html>
<head>    
      <title>Fracciones impropias</title>
      <meta charset="utf-8">
    ...
    {
      alert('El Numerador  debe ser MAYOR que el Denominador');
...
<div data-role="page">
    ...
    <a href="nivel2.php" target="_top" data-rel="home" class="ui-btn-left ui-btn  ui-btn-icon-notext ui-corner-all ui-icon-home">Home</a>
          <h1>MATFRA:Impropias</h1>
    
     </div>
  <form name="datos" method="POST" action="impropias_m.php">
 <div role="main" class="ui-content">
    <h2>Numerador</h2>
        <input name="num"  type="number" min="1" max="6" value="" size="4" maxlength="6" required/>
       <h2>Denominador</h2>  
    <input name="den" type="number" type="number" min="1" max="6" value="" size="4" maxlength="6" required /> 
